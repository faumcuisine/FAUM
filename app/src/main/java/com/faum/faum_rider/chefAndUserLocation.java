...
public class chefAndUserLocation extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
...
if(riderid != null && cookid != null) {
    ...
    public void sendRequestforconverting2(String riderlat,String riderlong) {
        ...
        try {
            ...
            //add = add + "\n" + obj.getThoroughfare();
            Log.v("IGA","Adress"+ add);
            /*addresses = geocoder.getFromLocation(latitude2,longitude2,1);
            String address = addresses.get(0).getAddressLine(0);
            String area = addresses.get(0).getSubThoroughfare();
            String area5 = addresses.get(0).getSubLocality();
            String area2 = addresses.get(0).getThoroughfare();
            String area3 = addresses.get(0).getUrl();
            //String area4 = addresses.get(0).getAddressLine(0);
            String area6 = addresses.get(0).getCountryCode();
            String area7 = addresses.get(0).getFeatureName();
            String area8 = addresses.get(0).getPostalCode();
            String area9 = addresses.get(0).getPremises();
            String fulladdress = area+area2+area3+area5+area6+area7+area8+area9;
            etOrigin.setText("1 "+area5+" 2 "+area7+" 3 "+area+" 4 "+area2+" 5 "+area3); */
