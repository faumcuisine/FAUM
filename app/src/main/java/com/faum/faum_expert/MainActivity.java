...
import static com.faum.faum_expert.Social_Connect.email;
import static com.faum.faum_expert.Social_Connect.uidemail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSocial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(MainActivity.this,Social_Connect.class);
            ...
            Userid.child(id).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        startActivity(new Intent(MainActivity.this,Navigation_Drawer.class));
                        finish();
                        ...
                        startActivity(new Intent(MainActivity.this,Contact_Infrormation.class));
                        finish();
