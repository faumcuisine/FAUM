...
public class recentOrderList2 extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        expertOrderConfirmedRefrence.child(id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                RecentList adapter = new RecentList( recentOrderList2.this,dealList);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(recentOrderList2.this,"Databse error", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
